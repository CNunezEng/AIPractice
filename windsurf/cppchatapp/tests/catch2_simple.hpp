...
// Simple Catch2 standalone header with only what we need
// This avoids benchmark and other complex includes
...
// We don't include catch_all.hpp to avoid benchmark dependencies
